 ...
 */
public class OnBuildingLoaded extends OnAbstractListInformationLoaded {
    public OnBuildingLoaded(OgameAgent agent, int type, List<AbstractItemInformation> list_information, Constants.Status success) {
