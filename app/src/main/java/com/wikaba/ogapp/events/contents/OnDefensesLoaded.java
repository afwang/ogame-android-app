 ...
 */
public class OnDefensesLoaded extends OnAbstractListInformationLoaded {
    public OnDefensesLoaded(OgameAgent agent, int type, List<AbstractItemInformation> list_information, Constants.Status success) {
