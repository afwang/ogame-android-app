 ...
 */
public class OnResourcesLoaded extends OnAbstractListInformationLoaded {
    public OnResourcesLoaded(OgameAgent agent, int type, List<AbstractItemInformation> list_information, Constants.Status success) {
