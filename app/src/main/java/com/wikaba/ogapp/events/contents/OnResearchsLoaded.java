 ...
 */
public class OnResearchsLoaded extends OnAbstractListInformationLoaded {
    public OnResearchsLoaded(OgameAgent agent, int type, List<AbstractItemInformation> list_information, Constants.Status success) {
